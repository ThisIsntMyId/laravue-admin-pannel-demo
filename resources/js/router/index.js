    ...
    children: [
      {
        ...
        name: 'Lambda',
        meta: { title: 'Index', icon: 'eye', noCache: true },
      },
      {
        path: 'products',
        component: () => import('@/views/dp/index'),
        name: 'Products',
        meta: { title: 'Products', icon: 'box', noCache: true },
      },
      {
        path: 'alpha',
        component: () => import('@/views/dp/alpha/index'),
        name: 'Alpha',
        meta: { title: 'Alpha', icon: 'money', noCache: true },
        children: [
          {
            path: 'babyalpha',
            component: () => import('@/views/dp/alpha/baby'),
            name: 'BabyAlpha',
            meta: { title: 'BabyAlpha', icon: 'qq', noCache: true },
          },
          {
            path: 'babaalpha',
            component: () => import('@/views/dp/alpha/baba'),
            name: 'BabaAlpha',
            meta: { title: 'BabaAlpha', icon: 'theme', noCache: true },
          },
        ],
      },
      {
        path: 'beta',
        component: () => import('@/views/dp/beta'),
        name: 'Beta',
        meta: { title: 'Beta', icon: 'people', noCache: true },
      },
    ],
  },
  {
    ...
    meta: {
      title: 'Our Products', icon: 'product',
    },
    children: [
      {
        path: 'index',
